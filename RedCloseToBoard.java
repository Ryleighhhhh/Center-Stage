...
@Autonomous (name = "RedCloseToBoard", group = "Meet 2")
public class RedCloseToBoard extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        elbowDrive(DRIVE_SPEED, armMove(75, 1), 1.0);
        clawL.setPosition(0.4);
        clawR.setPosition(0);
        elbowDrive(DRIVE_SPEED, armMove(-15, 1), 1.0);
