...
@Autonomous (name = "RedShortVisionHome", group = "Vision Auto")
public class RedShortVisionHome extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        switch (pipeline.getAnalysis()) {
            case LEFT:
                ...
                clawR.setPosition(0.4); //lets go of yellow pixel
            ...
            case CENTER:
                ...
                clawR.setPosition(0);
                encoderDrive(DRIVE_SPEED, -arc90, arc90, -arc90, arc90, 5.0); //turns RIGHT towards board
                clawR.setPosition(0);
                ...
                clawR.setPosition(0);
                elbowDrive(DRIVE_SPEED, armMove(-40, 1), 1.0); //arm moves back
